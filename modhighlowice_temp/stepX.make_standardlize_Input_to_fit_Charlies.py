#### We neeed to run this script to get the input X value to standardize the X as Charlies', 
#### the output here equals to the X_all in Charlie's emulator code.
#### there's duplication on the mod simulations, since they are considered as part of two emulators:gl and ig.
...
input_data = pd.DataFrame(columns=['co2','obliquity','esinw','ecosw','ice'], dtype=float)
...
input_data.to_csv('training_data/emul_in_X_Char.res', sep='\t', index=False)
