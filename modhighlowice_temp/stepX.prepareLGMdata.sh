...
# Define file paths
output_path5="dT500_temp_mm_1_5m_ann_tdab28k.nc"
output_path6="dT500_temp_mm_1_5m_ann_tdab80k.nc"
output_path7="dT500_temp_mm_1_5m_ann_tdab120k.nc"
...
output_all="dT500_temp_mm_1_5m_ann_tdab_all.nc"
...
ncks -v "$(IFS=,; echo "${output_list5[*]}")" "${output_all}" -O dT500_temp_mm_1_5m_ann_tdab28k_anomaly.nc
ncks -v "$(IFS=,; echo "${output_list6[*]}")" "${output_all}" -O dT500_temp_mm_1_5m_ann_tdab80k_anomaly.nc
ncks -v "$(IFS=,; echo "${output_list7[*]}")" "${output_all}" -O dT500_temp_mm_1_5m_ann_tdab120k_anomaly.nc
